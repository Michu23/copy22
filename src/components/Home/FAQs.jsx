...
const FAQs = () => {
  const faqsData = [
    ...
    { sl: "05", question: "Is there a need for me to modify or redevelop my queries?", answer: "There is no need for any effort or migration when it comes to copying and pasting existing queries. It can be done effortlessly." },
    ...
    { sl: "07", question: "What is the deployment process for DView like? Is it complex, and do I require DevOps expertise to deploy it?", answer: "To deploy our components, we require minimum details about your private cloud. Your team can effortlessly deploy the necessary data infrastructure using a no/low code approach." },
  ];
